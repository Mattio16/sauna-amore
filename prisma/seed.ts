...
const OPTIONS = [
  { group: 'wood', code: 'spruce', image: '/images/options/spruce.jpg', description: 'Light Nordic spruce with 40 mm solid walls — the classic sauna look. Benefits from a protective wood treatment every few years.', nameIt: 'Abete classico', nameEn: 'Classic spruce', sortOrder: 0 },
  { group: 'wood', code: 'thermowood', image: '/images/options/thermowood.jpg', description: 'Heat-treated timber: darker tone, higher durability and much lower maintenance. Resists moisture and insects without treatment.', nameIt: 'Thermowood premium', nameEn: 'Premium thermowood', sortOrder: 1 },
  { group: 'sauna-heater', code: 'electric-standard', image: '/images/options/electric-standard.jpg', description: 'Harvia electric stove sized to the sauna (6–9 kW), sauna stones included. Set the temperature and it is ready in about an hour.', nameIt: 'Elettrica standard (Harvia)', nameEn: 'Standard electric (Harvia)', sortOrder: 0 },
  { group: 'sauna-heater', code: 'electric-smart', image: '/images/options/electric-smart.jpg', description: 'HUUM Drop 9 kW with UKU WiFi control: start the sauna from your phone and arrive to 80°. 55 kg of stones for soft, even steam.', nameIt: 'Elettrica smart (HUUM + WiFi)', nameEn: 'Smart electric (HUUM + WiFi)', sortOrder: 1 },
  { group: 'sauna-heater', code: 'wood-fired', image: '/images/options/wood-fired.jpg', description: 'The authentic ritual: crackling fire, no electricity needed. Complete set with chimney kit and sauna stones.', nameIt: 'A legna (set con canna fumaria)', nameEn: 'Wood-fired (incl. chimney set)', sortOrder: 2 },
  ...
  { group: 'tub-filter', code: 'filter-set', image: '/images/options/filter-set.jpg', description: 'Circulation filter set keeps the water clean and clear for weeks between changes.', nameIt: 'Set filtrazione', nameEn: 'Filter set', sortOrder: 1 },
  ...
  { group: 'tub-cover', code: 'insulated-cover', image: '/images/options/insulated-cover.jpg', description: 'Insulated lid keeps the heat overnight (less firewood to reheat) and keeps leaves and rain out.', nameIt: 'Copertura isolata', nameEn: 'Insulated cover', sortOrder: 1 },
  ...
  { group: 'chiller', code: 'chiller-pro', image: '/images/options/chiller-pro.webp', description: '7 kW chiller with filtration keeps the water at 4–6° all year round, always ready to plunge. The gym and hospitality spec.', nameIt: 'Chiller Pro 7kW + filtro (sempre freddo)', nameEn: 'Pro chiller 7kW + filter (always cold)', sortOrder: 1 },
  { group: 'diameter', code: 'd2', image: '/images/options/d2.jpg', description: 'Standard Ø2 m barrel: 210 cm interior height, fits most gardens and doorways.', nameIt: 'Ø2 m', nameEn: 'Ø2 m', sortOrder: 0 },
  { group: 'diameter', code: 'd22', image: '/images/options/d22.jpg', description: 'Ø2.2 m barrel: 20 cm more headroom (230 cm) and noticeably wider benches. Worth it for taller users.', nameIt: 'Ø2,2 m (più alta e spaziosa)', nameEn: 'Ø2.2 m (taller and roomier)', sortOrder: 1 },
  { group: 'roof', code: 'roof-brown', image: '/images/options/roof-brown.jpg', description: 'Brown bitumen shingles — the warm classic that suits spruce especially well. Included in the price.', nameIt: 'Marrone', nameEn: 'Brown', sortOrder: 0 },
  { group: 'roof', code: 'roof-black', image: '/images/options/roof-black.jpg', description: 'Black bitumen shingles — a sharp, modern look that pairs beautifully with thermowood. Included in the price.', nameIt: 'Nero', nameEn: 'Black', sortOrder: 1 },
  { group: 'roof', code: 'roof-green', image: '/images/options/roof-green.jpg', description: 'Green bitumen shingles — blends the sauna into hedges and garden greenery. Included in the price.', nameIt: 'Verde', nameEn: 'Green', sortOrder: 2 },
  ...
  { group: 'stairs', code: 'stairs-classic', image: '/images/options/stairs-classic.jpg', description: 'Solid wooden three-step ladder — the safe, easy way in and out.', nameIt: 'Scaletta classica', nameEn: 'Classic stairs', sortOrder: 1 },
  { group: 'stairs', code: 'stairs-lux', image: '/images/options/stairs-lux.jpg', description: 'Curved two-tier LUX platform that hugs the tub — doubles as a seat and looks built-in.', nameIt: 'Scaletta LUX', nameEn: 'Stairs LUX', sortOrder: 2 },
  ...
  { group: 'jacuzzi', code: 'bubble-system', image: '/images/options/bubble-system.jpg', description: 'Air bubble system: thousands of soft bubbles from the seats — gentle, playful massage.', nameIt: 'Sistema bolle', nameEn: 'Bubble system', sortOrder: 1 },
  { group: 'jacuzzi', code: 'hydromassage', image: '/images/options/hydromassage.jpg', description: 'Hydromassage jets: directed water streams for a real massage on back and shoulders.', nameIt: 'Idromassaggio', nameEn: 'Hydromassage', sortOrder: 2 },
  { group: 'jacuzzi', code: 'bubble-hydro', image: '/images/options/bubble-hydro.jpg', description: 'The full set: bubbles plus hydromassage jets — the complete spa experience.', nameIt: 'Bolle + idromassaggio', nameEn: 'Bubble + hydromassage set', sortOrder: 3 },
  { group: 'led', code: 'no-led', description: 'No underwater lighting.', nameIt: 'Senza LED', nameEn: 'No LED light', sortOrder: 0 },
  { group: 'led', code: 'led-1', image: '/images/options/led-1.jpg', description: 'One underwater LED — a warm glow for evening soaks.', nameIt: '1 luce LED', nameEn: '1 LED light', sortOrder: 1 },
  { group: 'led', code: 'led-2', image: '/images/options/led-2.jpg', description: 'Two underwater LEDs for even lighting across the tub.', nameIt: '2 luci LED', nameEn: '2 LED lights', sortOrder: 2 },
  { group: 'led', code: 'led-8', image: '/images/options/led-8.jpg', description: 'Eight LEDs around the rim — the tub becomes a glowing centrepiece at night.', nameIt: '8 luci LED', nameEn: '8 LED lights', sortOrder: 3 },
  ...
  { group: 'front-windows', code: 'fw-2-fixed', image: '/images/options/fw-2-fixed.jpg', description: 'Two fixed windows either side of the door bring daylight into the cabin.', nameIt: '2 finestre fisse', nameEn: '2 non-openable windows', sortOrder: 1 },
  { group: 'front-windows', code: 'fw-2-open', image: '/images/options/fw-2-open.jpg', description: 'Two opening windows for daylight plus quick airing between sessions.', nameIt: '2 finestre apribili', nameEn: '2 openable windows', sortOrder: 2 },
  { group: 'front-windows', code: 'fw-glass-wall', image: '/images/options/fw-glass-wall.webp', description: 'Full tempered-glass front wall with glass door — the panoramic experience, safe next to the stove.', nameIt: 'Parete vetrata con porta in vetro', nameEn: 'Glass wall with glass door', sortOrder: 3 },
  ...
  { group: 'back-windows', code: 'bw-2-fixed', image: '/images/options/bw-2-fixed.jpg', description: 'Two fixed windows on the back wall for light from both sides.', nameIt: '2 finestre fisse', nameEn: '2 non-openable windows', sortOrder: 1 },
  { group: 'back-windows', code: 'bw-2-open', image: '/images/options/bw-2-open.jpg', description: 'Two opening back windows — cross-ventilation dries the cabin quickly.', nameIt: '2 finestre apribili', nameEn: '2 openable windows', sortOrder: 2 },
