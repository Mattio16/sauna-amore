...
const it = {
  ...
  faq: {
    ...
    groups: [
      ...
      { h: "Uso e cura", items: [
        ["Come si usa la sauna?", "La sauna a botte scalda più in fretta di una squadrata: bastano 30–60 minuti per arrivare a 70–90°. Resta dentro 10–15 minuti, rinfrescati all’aperto o in acqua fredda, riposa e ripeti due o tre volte. Bevi molta acqua e versa acqua sulle pietre per il classico vapore morbido."],
        ["Come si cura la sauna?", "Tieni libere le aperture di ventilazione: il ricircolo d’aria è la miglior difesa contro la muffa. Tratta l’interno con un antisettico per sauna circa una volta l’anno e l’esterno ogni uno o due anni (il thermowood ne richiede meno). Controlla ogni tanto i cerchi in acciaio e stringili se serve: le doghe restano in tensione e la porta non si abbassa."],
        ...
        ["Come si pulisce e si cura l’acqua?", "Senza trattamenti, svuota la vasca dopo l’uso — al massimo qualche sessione — e risciacqua. Se la usi spesso, aggiungi il set di filtrazione e i normali prodotti per piscina in piccole dosi contro alghe e batteri: l’acqua resta fresca per settimane. Pulisci la vetroresina con un detergente delicato non abrasivo e tieni sempre la copertura quando la vasca non è in uso."],
        ["Posso lasciare l’acqua nella vasca d’inverno?", "Non durante i periodi di gelo, a meno che la vasca non resti attiva: il ghiaccio danneggia vetroresina e stufa. Per la pausa invernale: svuota completamente vasca e stufa, lascia aperta la valvola di scarico, tappa gli attacchi della stufa e metti la copertura. Se invece vuoi usarla tutto l’inverno — la stagione più bella — tienila piena e in funzione: la copertura isolata fa il resto."],
        ["Come si cura il legno?", "Il thermowood non richiede quasi manutenzione, ma all’aperto vira lentamente al grigio argento: un olio protettivo di tanto in tanto mantiene il tono scuro originale. L’abete va trattato ogni uno o due anni. Nelle estati calde e secche tieni 10–15 cm d’acqua nella vasca in legno con il coperchio, cambiandola ogni settimana: le doghe non si seccano e non si ritirano."],
...
const en: Dict = {
  ...
  faq: {
    ...
    groups: [
      ...
      { h: "Use & care", items: [
        ["How do I use the sauna?", "A barrel sauna heats faster than a square one — about 30–60 minutes to 70–90°. Stay in for 10–15 minutes, cool off outside or in cold water, rest, and repeat two or three times. Drink plenty of water, and ladle water over the stones for the classic soft steam."],
        ["How do I look after the sauna itself?", "Keep the ventilation openings clear — airflow is the best protection against mould. Treat the interior with a sauna-safe antiseptic about once a year and the exterior every one to two years (thermowood needs less). Check the steel hoops now and then and tighten them if needed, so the staves stay snug and the door doesn’t sag."],
        ...
        ["How do I clean it and care for the water?", "Without any treatment, simply drain the tub after use — a few sessions at most — and rinse. If you use it often, add the filter set and standard pool-care products in small doses to keep algae and bacteria away; the water then stays fresh for weeks. Wipe fiberglass with a mild, non-abrasive soap, and always keep the cover on when the tub is not in use."],
        ["Can I leave water in the tub over winter?", "Not during frost periods, unless the tub is actively kept warm or running — ice will damage both the fiberglass and the stove. For a winter break: drain the tub and the stove completely, leave the drain valve open, plug the stove connections and put the cover on. If you would rather use it all winter — the best season — keep it filled and in use, and the insulated cover does the rest."],
        ["How do I care for the wood?", "Thermowood needs almost no maintenance, though outdoors it slowly turns silver-grey; an occasional protective oil keeps the original dark tone. Spruce wants a protective treatment every year or two. In hot, dry summers keep 10–15 cm of water in a wooden tub with the lid on, changed weekly, so the staves don’t dry out and shrink."],
  ...
  faq: {
    ...
    groups: [
      ...
      { h: "Gebruik & onderhoud", items: [
        ["Hoe gebruik ik de sauna?", "Een barrelsauna warmt sneller op dan een vierkante: in 30–60 minuten zit je op 70–90°. Blijf 10–15 minuten binnen, koel af buiten of in koud water, rust en herhaal twee of drie keer. Drink veel water en schep water op de stenen voor de klassieke zachte stoom."],
        ["Hoe onderhoud ik de sauna zelf?", "Houd de ventilatieopeningen vrij — luchtcirculatie is de beste bescherming tegen schimmel. Behandel het interieur ongeveer eens per jaar met een sauna-antisepticum en de buitenkant elke één à twee jaar (thermowood vraagt minder). Controleer zo nu en dan de stalen banden en trek ze aan indien nodig, zodat de duigen strak blijven en de deur niet gaat hangen."],
        ...
        ["Hoe maak ik schoon en verzorg ik het water?", "Zonder behandeling: laat de tub na gebruik — hooguit een paar sessies — leeglopen en spoel na. Gebruik je hem vaak, voeg dan de filterset toe en standaard zwembadproducten in kleine doses tegen algen en bacteriën; het water blijft dan weken fris. Neem glasvezel af met een mild, niet-schurend middel en houd de cover erop als de tub niet in gebruik is."],
        ["Kan het water er in de winter in blijven?", "Niet tijdens vorstperiodes, tenzij de tub actief warm of in bedrijf blijft: ijs beschadigt zowel de glasvezel als de kachel. Voor een winterstop: tub en kachel volledig aftappen, aftapkraan open laten, kachelaansluitingen afdoppen en de cover erop. Wil je hem juist de hele winter gebruiken — het mooiste seizoen — houd hem dan gevuld en in gebruik; de geïsoleerde cover doet de rest."],
        ["Hoe onderhoud ik het hout?", "Thermowood vraagt vrijwel geen onderhoud, maar wordt buiten langzaam zilvergrijs; af en toe een beschermende olie behoudt de oorspronkelijke donkere tint. Vurenhout wil elke één à twee jaar een beschermende behandeling. Houd in hete, droge zomers 10–15 cm water in een houten tub met het deksel erop, wekelijks ververst — zo drogen de duigen niet uit."],
  ...
  faq: {
    ...
    groups: [
      ...
      { h: "Nutzung & Pflege", items: [
        ["Wie benutze ich die Sauna?", "Eine Fasssauna heizt schneller auf als eine eckige: in 30–60 Minuten sind 70–90° erreicht. 10–15 Minuten bleiben, draußen oder im kalten Wasser abkühlen, ruhen, zwei- bis dreimal wiederholen. Viel trinken — und Wasser über die Steine gießen für den klassischen weichen Aufguss."],
        ["Wie pflege ich die Sauna selbst?", "Halten Sie die Lüftungsöffnungen frei — Luftzirkulation ist der beste Schutz gegen Schimmel. Behandeln Sie den Innenraum etwa einmal im Jahr mit einem saunageeigneten Antiseptikum, die Außenseite alle ein bis zwei Jahre (Thermoholz braucht weniger). Prüfen Sie gelegentlich die Stahlreifen und ziehen Sie sie bei Bedarf nach, damit die Dauben straff sitzen und die Tür nicht absackt."],
        ...
        ["Wie reinige und pflege ich das Wasser?", "Ohne Behandlung: die Tub nach dem Gebrauch — höchstens ein paar Sitzungen — entleeren und ausspülen. Bei häufiger Nutzung: Filterset plus übliche Poolpflegeprodukte in kleinen Dosen gegen Algen und Bakterien — das Wasser bleibt dann wochenlang frisch. Glasfaserflächen mit mildem, nicht scheuerndem Reiniger abwischen und die Abdeckung immer nutzen, wenn die Tub nicht in Gebrauch ist."],
        ["Kann das Wasser im Winter in der Tub bleiben?", "Nicht während Frostperioden, außer die Tub bleibt aktiv warm oder in Betrieb: Eis beschädigt Glasfaser und Ofen. Für die Winterpause: Tub und Ofen vollständig entleeren, Ablassventil offen lassen, Ofenanschlüsse verschließen und die Abdeckung auflegen. Wer die Tub den ganzen Winter nutzen will — die schönste Saison — hält sie gefüllt und in Betrieb; die isolierte Abdeckung erledigt den Rest."],
        ["Wie pflege ich das Holz?", "Thermoholz braucht kaum Pflege, wird im Freien aber langsam silbergrau; gelegentlich ein Schutzöl erhält den ursprünglich dunklen Ton. Fichte möchte alle ein bis zwei Jahre eine Schutzbehandlung. Halten Sie in heißen, trockenen Sommern 10–15 cm Wasser in einer Holz-Tub mit aufgelegtem Deckel, wöchentlich gewechselt — so trocknen die Dauben nicht aus."],
  ...
  faq: {
    ...
    groups: [
      ...
      { h: "Использование и уход", items: [
        ["Как пользоваться сауной?", "Бочка прогревается быстрее квадратной сауны: 30–60 минут до 70–90°. 10–15 минут внутри, охлаждение на воздухе или в холодной воде, отдых — и так два-три круга. Пейте больше воды и поддавайте на камни для мягкого пара."],
        ["Как ухаживать за самой сауной?", "Держите вентиляционные отверстия открытыми — циркуляция воздуха лучшая защита от плесени. Обрабатывайте интерьер безопасным для сауны антисептиком примерно раз в год, наружную часть — раз в один-два года (термодереву нужно меньше). Время от времени проверяйте стальные обручи и подтягивайте их: доски остаются в натяге, дверь не провисает."],
        ...
        ["Как чистить и ухаживать за водой?", "Без обработки просто сливайте воду после использования — максимум после нескольких сеансов — и ополаскивайте. При частом использовании добавьте фильтр-комплект и обычные средства для бассейна в малых дозах против водорослей и бактерий — вода останется свежей неделями. Стеклопластик протирайте мягким неабразивным средством и всегда закрывайте крышкой, когда купель не используется."],
        ["Можно ли оставлять воду на зиму?", "В морозы — нет, если купель не остаётся тёплой или в работе: лёд повреждает и стеклопластик, и печь. На зимнюю паузу: полностью слейте воду из купели и печи, оставьте сливной кран открытым, заглушите патрубки печи и закройте крышкой. А если хотите пользоваться всю зиму — лучший сезон — держите её наполненной и в работе: утеплённая крышка сделает остальное."],
        ["Как ухаживать за деревом?", "Термодерево почти не требует ухода, но на улице постепенно сереет; защитное масло время от времени сохраняет тёмный тон. Ель обрабатывайте раз в один-два года. В жаркое сухое лето держите в деревянной купели 10–15 см воды под крышкой, меняя её раз в неделю, — доски не рассохнутся."],
