...
export default function ContactPage() {
  ...
  const content = {
    en: {
      ...
      messagePlaceholder: 'Tell us about your sauna needs...',
      ...
      email: 'info@saunaamore.it',
      phone: '+39 0733 123456',
      whatsapp: '+39 0733 123456',
      location: 'Le Marche, Italia',
      hours: 'Mon-Sat 9:00 AM - 6:00 PM',
      mapPlaceholder: 'Le Marche, Italia',
    ...
    it: {
      ...
      messagePlaceholder: 'Raccontaci delle tue esigenze di sauna...',
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-3 border border-sage-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={5}
                  required
                  className="w-full px-4 py-3 border border-sage-200 rounded-lg focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-200 transition-all resize-none"
                ></textarea>
              </div>
              ...
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-teal-500 to-teal-600 text-white font-semibold rounded-lg hover:shadow-lg hover:from-teal-600 hover:to-teal-700 transition-all duration-300"
              >
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 border border-sage-100">
              ...
              <div className="mb-6 pb-6 border-b border-sage-100">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-gradient-to-br from-teal-100 to-sage-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Mail className="w-6 h-6 text-teal-600" />
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t.emailHeading}</h4>
                    <a
                      href={`mailto:${t.email}`}
              ...
              <div className="mb-6 pb-6 border-b border-sage-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t.phoneHeading}</h4>
                    <a
                      href={`tel:${t.phone}`}
                      className="text-teal-600 hover:text-teal-700 font-medium transition-colors"
                    >
              ...
              <div className="mb-6 pb-6 border-b border-sage-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t.whatsappHeading}</h4>
                    <a
              ...
              <div className="mb-6 pb-6 border-b border-sage-100">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t.locationHeading}</h4>
                    <p className="text-gray-600 font-medium">{t.location}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-gray-900 mb-1">{t.hoursHeading}</h4>
                    <p className="text-gray-600 font-medium">{t.hours}</p>
                  </div>
                </div>
              </div>
            </div>
